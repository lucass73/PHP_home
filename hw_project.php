...
//                          }
    ...
    <div id="page_num">
        ...
        ?>
      <a href="/page/board/write_project.php"><button>글쓰기</button></a>
  </div>
  <div id="search_box">
    <form action="/page/board/search_result_project.php" method="get">
      <select name="catgo">
        <option value="pj">프로젝트명</option>
        <option value="bidtype">입찰방식</option>
