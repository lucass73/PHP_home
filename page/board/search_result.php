...
?>
  ...
  <h4 style="margin-top:30px;"><a href="/board/index.php">홈으로</a></h4>
    <table class="list-table">
      ...
      <tbody>
        <tr>
          ...
          <td width="500">
            <?php 
              ...
              { ?><a href='/board/page/board/ck_read.php?idx=<?php echo $board["idx"];?>'><?php echo $title, $lockimg;
              }else{?>
        ...
        <?php
          ...
          ?>
        <!--- 추가부분 18.08.01 END -->
        <a href='/board/page/board/read.php?idx=<?php echo $board["idx"]; ?>'><span style="background:yellow;"><?php echo $title; }?></span><span class="re_ct">[<?php echo $rep_count;?>]<?php echo $img; ?> </span></a></td>
    ...
    <!-- 18.10.11 검색 추가 -->
    <div id="search_box2">
      <form action="/board/page/board/search_result.php" method="get">
      <select name="catgo">
